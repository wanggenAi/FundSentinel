...
export const DATA_SOURCE_CATALOG: DataSourceCatalogEntry[] = [
  {
    ...
    recommended_for: ["fund_reports", "fund_meta", "official_evidence"],
    ...
    priority: 1,
    notes: "Primary authoritative source for public fund disclosure. Target website appears in fund-company prompt notices as http://eid.csrc.gov.cn/fund."
  },
  {
  ...
  },
  {
    ...
    recommended_for: ["fund_reports", "holdings_cross_check", "official_announcements"],
  ...
  },
  {
    ...
    recommended_for: ["current_nav", "fund_reports", "fund_meta"],
  ...
  },
  {
    ...
    recommended_for: ["nav_history", "current_nav", "portfolio_holdings", "bootstrap_validation"],
  ...
  },
  {
    ...
    recommended_for: ["production_data", "cross_source_validation"],
  ...
  },
  {
    ...
    recommended_for: ["official_company_cross_check", "fund_reports", "current_nav"],
